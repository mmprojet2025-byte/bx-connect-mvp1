          ...
          <section className="bg-white rounded-2xl shadow overflow-hidden flex flex-col" style={{ height: '70vh' }}>
            ...
            <form onSubmit={handleEnvoyer} className="px-4 py-3 border-t border-gray-100 flex gap-3 items-center">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center text-white transition disabled:bg-gray-300 bg-blue-700 hover:bg-blue-600"
              >
                ➤
              </button>
            </form>
  ...
  return (
    <div className={`flex items-end gap-2 ${estMoi ? 'flex-row-reverse' : 'flex-row'}`}>
      ...
      <div className="max-w-xs md:max-w-md">
        ...
        <div className={`px-4 py-2 text-sm leading-relaxed break-words ${estMoi ? 'bg-blue-700 text-white' : 'bg-gray-100 text-blue-900'}`} style={{ borderRadius: estMoi ? '12px 12px 2px 12px' : '12px 12px 12px 2px' }}>
          {message.contenu}
        </div>
