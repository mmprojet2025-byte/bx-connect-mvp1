...
const styles = StyleSheet.create({
  ...
  content: { flexGrow: 1, justifyContent: 'center', padding: 14, paddingVertical: 24 },
  card: {
    borderRadius: 22,
    borderWidth: 1,
  ...
  logo: { alignSelf: 'center', width: 152, height: 44, marginBottom: 10 },
  title: { color: COLORS.bxBlue, fontSize: 21, fontWeight: '900', textAlign: 'center' },
  subtitle: { color: COLORS.muted, fontSize: 12, lineHeight: 17, textAlign: 'center', marginTop: 6, marginBottom: 16 },
  successBox: {
    flexDirection: 'row',
